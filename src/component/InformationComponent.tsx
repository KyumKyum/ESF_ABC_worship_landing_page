  ...
  return (
    <div className="relative w-full px-12">
      <div className="flex flex-col w-full justify-center">
        <p className="mb-12 font-snow text-white text-center ">
        ...
        <p className="my-12 font-snow text-white text-center">Wherever you're from,</p>
        <p className="my-12 font-snow text-white text-center">Whatever you've been through,</p>
        <p className="my-12 font-snow text-white text-center">He was always there with you.</p>
        <p className="my-12 font-snow text-white text-center">Now we invite you to be with Him.</p>
